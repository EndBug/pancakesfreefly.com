...
export async function generateMetadata({
  ...
  const event = getEventById("ag-skill-camp-sep24");
...
export default async function AgSkillCampSep24Page({
  params,
}: {
  params: Promise<{ locale: string }>;
}) {
  ...
  return <EventLayout eventId="ag-skill-camp-sep24">{null}</EventLayout>;
}
