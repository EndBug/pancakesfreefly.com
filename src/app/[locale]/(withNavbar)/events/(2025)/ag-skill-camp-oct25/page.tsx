...
export async function generateMetadata({
  ...
  const event = getEventById("ag-skill-camp-oct25");
...
export default async function AgSkillCampOct25Page({
  params,
}: {
  params: Promise<{ locale: string }>;
}) {
  ...
  return <EventLayout eventId="ag-skill-camp-oct25">{null}</EventLayout>;
}
