...
export async function generateMetadata({
  ...
  const event = getEventById("ag-skill-camp-feb25");
...
export default async function AgSkillCampFeb25Page({
  params,
}: {
  params: Promise<{ locale: string }>;
}) {
  ...
  return <EventLayout eventId="ag-skill-camp-feb25">{null}</EventLayout>;
}
